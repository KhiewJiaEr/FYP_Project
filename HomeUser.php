...
<main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header mb-3 mb-lg-5">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-header-title">Welcome Home, <?php echo htmlentities($row_User['Username']) ?></h1>
                </div>
                <!-- End Col -->

                <div class="col">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a class="btn btn-primary" href="AddTransaction.php"><i class="bi bi-plus-circle"></i> Add Transaction</a>
                    </div>
                </div>
                <!-- End Col -->
            </div>
        ...
        <div class="row">
            <div class="card">
                    ...
                    <div class="row justify-content-between align-items-center flex-grow-1">
                        <div class="col-9 col-md">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-header-title">Transaction</h5>
                            </div>
                        </div>
                ...
                >
                        ...
                        <tbody>
                            <?php
                                $sql_select = "SELECT transaction_tbl.TransactionID, transaction_tbl.UserID, category_tbl.CategoryType, category_tbl.CategoryGroup, transaction_tbl.Amount, transaction_tbl.Note, transaction_tbl.DateTime from transaction_tbl
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><a href="EditTransaction.php?id=<?php echo $row['TransactionID'] ?>"  class="btn btn-success"><i class="bi bi-pencil"></i> Edit</a></td>
                                            <td><a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModalToggle<?php echo $row['TransactionID'] ?>"><i class="bi bi-trash"></i> Delete</a></td>
                                        </tr>
                            <?php
                                    }
                                }
    ...
    <?php
        foreach ($transaction_no as $row) {
    ?>
            <div class="modal fade" id="deleteModalToggle<?php echo $row['TransactionID']; ?>" aria-hidden="true" aria-labelledby="deleteModalToggleLabel" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="deleteModalToggleLabel">Delete Transaction</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <p>Are you sure you want to delete this?</p>
                            <p><?php echo $row['CategoryType']; ?> <?php echo $currencySymbol . number_format($row['Amount'], 2); ?> (<?php echo $row['DateTime']; ?>)</p>


                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                            <button class="btn btn-danger" onclick="confirmDelete(<?php echo $row['TransactionID']; ?>)">Confirm</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="deleteAllModalToggle" aria-hidden="true" aria-labelledby="deleteAllModalToggleLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="deleteAllModalToggleLabel">Delete All Transaction</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    Are you sure you want to delete All of the Transaction History?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
    ...
    <script>
        ...
        function confirmDelete(transactionID) {
            window.location.href = "DeleteTransaction.php?id=" + transactionID;
        }

        function confirmDeleteAll() {
            window.location.href = "DeleteAllTransaction.php";
        }
